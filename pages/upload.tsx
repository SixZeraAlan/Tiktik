    ...
    <div className='flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
        ...
        <div>
            <div>
                ...
                <p className='text-md text-gray-400'>Post a vide to your account</p>
            </div>
        ...
        <div className='flex flex-col gap-3 pb-10'>
            <label className='text-md font-bold'>Caption</label>
            <input
            type='text'
            value={caption}
            ...
            ></input>
            <label className='text-md font-bold'>Choose a Category</label>
            <select
